...
class Config:
    ...
    hf_config: AutoConfig | None = None  # HuggingFace模型配置，会在初始化时自动加载    eos: int = -1  # 结束符token ID，会在初始化时从tokenizer获取
    ...
    def __post_init__(self):
        ...
        self.hf_config = AutoConfig.from_pretrained(self.model)  # 加载HuggingFace模型配置
